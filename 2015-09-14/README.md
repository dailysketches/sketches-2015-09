Sketch 2015-09-14
--
This subfolder of the [sketches-2015-09 repo](https://github.com/dailysketches/sketches-2015-09) is the root of an individual openFrameworks sketch. It contains the full source code used to generate this sketch:

![Sketch 2015-09-14](https://github.com/dailysketches/sketches-2015-09/blob/master/2015-09-14/bin/data/out/2015-09-14.gif?raw=true)

This source code is published automatically along with each sketch I add to [Daily Sketches](http://dailysketches.github.io). Here is a [permalink to this sketch](http://dailysketches.github.io/sketch-14-09-2015/) on the Daily Sketches site.
